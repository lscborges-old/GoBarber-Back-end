...
- As notificações do prestador devem ser enviadas em tempo-real utiliznado Socket.io;
...
- Os agendamentos devem estar disponíveis entre 8h ás 18h (Primeiro às 8h, ultimo às 17h);
